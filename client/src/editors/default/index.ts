...
class MSNotepadEditor extends Editor {
	spawn: any = null;
    #pythonScriptPath = path.resolve(__dirname, 'robot-impl.py');
	...
	/**
	 * This should check if python is available, since
	 * this editor depends on python.
	 * 
	 */
	async checkPrerequisites(): Promise<void> {
		// No error! Let's just always assume python is present!
	}
