 ...
 */
export function allRecognizablePhrases(graph, templates) {
...
export function listArchives(filter, all = false) {
...
export async function automataToImage(automataPath, fileName) {
...
function allPaths(graph, u, d, isVisited, localPathList, results) {
    if (u === d) {
