...
export default React.memo(function Webapp(props) {
    const i18n = i18n_[props.lang];
            ...
            <main className="home">
                <div className="content">
                    <iframe 
                        width="560" 
                        height="315" 
                        src="https://www.youtube.com/embed/I71ETEeqa5E" 
...
const i18n_ = {
    'en-US': {
        ...
        'extension': (
            <>
                ...
                which allows it to communicate with and control VSCode.
            </>
        ),
        'limit': (
            <>
        ...
        'source': (
            <>
                Check out the <a rel='noreferrer' href={process.env.PUBLIC_URL + '/en/webapp'}>demo</a> to see it working or read more about it in the&nbsp;
    ...
    'pt-BR': {
        ...
        'limit': (
            <>
                Atualmente só existe suporte para a linguagem de programação JavaScript e o editor Visual Studio Code.
            </>
        ),
        'source': (
            <>
