...
export default function Header() {
    ...
    const selectedEditor = (context.editorState || []).find((a) => (a.status === 'ON' && a.current)) || {};
    const [appVersion, setAppVersion] = useState(window.electronShellInfo?.appVersion);
                    ...
                    <div className="settings-list">
                        <div className="setting">
                            ...
                            <select
                                ...
                                onChange={(evt) => context.changeEditor(evt.target.value)}
                            >
                                {!selectedEditor.name && (
                                    <option label=" "></option>
                                )}
                                {(context.editorState || []).map((item) =>
                                    <option
                                        value={item.name}
                        ...
                        <div className="setting">
                            ...
                            <select
                                ...
                                onChange={(evt) => context.changeLanguage(evt.target.value)}
                            >
                                {langs.map((item) =>
                                    <option
                                        value={item.lang}
...
const texts = {
    ...
    'pt-BR': {
        ...
        'Displays a text box where you can write commands instead of saying it':
            'Exibe uma caixa de texto onde você pode escrever comandos ao invés de dizê-los',
