...
const Link = ({ h, children }) => (
    <a
        href={'https://github.com/pedrooaugusto/speech-to-code/tree/main/spoken/src/modules/typescript/' + h + '#readme'}
        target="_blank"
        rel="noreferrer"
    >
        {children}
...
const texts = {
    'en-US': {
        'vscode_requirement': (
            <>
                To use this tool it is necessary to have Visual Studio Code installed.
                ...
                start this application in that order for the connection to be successful.
                <br/><br/>
            </>
        ),
        'list_commands_exp': (
            <>
                ...
                The complete list of voice commands can be found in <a href="#/spoken"><i>/Modules</i></a>.
            </>
        ),
    },
    'pt-BR': {
        ...
        'vscode_requirement': (
            <>
                ...
                aplicação é feita através de uma extensão chamada Spoken que é
                ...
                esteja em uma das linhas deste arquivo.
                <br/><br/>
            </>
        ),
        'list_commands_exp': (
...
const _i18n = (lang) => (textId) => texts[lang][textId] || textId;
